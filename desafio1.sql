...
INSERT INTO plano (id, tipo, preco)
VALUES
  ('1', 'gratuito', '0'),
  ('2', 'pessoal', '6.99'),
  ('3', 'familiar', '7.99'),
...
INSERT INTO usuario (id, nome, idade, plano_id, data_assinatura)
VALUES
  ('1', 'Thati', '23', '1', '2019-10-20'),
  ('2', 'Cintia', '35', '3', '2017-12-30'),
  ('3', 'Bill', '20', '4', '2019-06-05'),
  ('4', 'Roger', '45', '2', '2020-05-13'),
  ('5', 'Norman', '58', '2', '2017-02-17'),
  ('6', 'Patrick', '33', '3', '2017-01-06'),
  ('7', 'Vivian', '26', '4', '2018-01-05'),
  ('8', 'Carol', '19', '4', '2018-02-14'),
  ('9', 'Angelina', '42', '3', '2018-04-29'),
  ('10', 'Paul', '46', '3', '2017-01-17');
...
INSERT INTO album (id, nome, ano_lancamento, artista_id)
VALUES
  ('1', 'Envious', '1990', '1'),
  ('2', 'Exuberant', '1993', '1'),
...
INSERT INTO cancoes (id, nome, duracao_segundos, album_id)
VALUES
  ('1', 'Soul For Us', '200', '1'),
...
INSERT INTO historico_de_reproducoes (data_reproducao, usuario_id, cancao_id)
VALUES
